...
import com.tenafic.webapp.entity.Employee;
...
public class EmployeeProxy {
    ...
    public Iterable<Employee> getEmployees() {
        ...
        String getEmployeesUrl = baseApiUrl + "/api/employees";
    ...
    public Employee getEmployee(int id) {
        String baseApiUrl = props.getApiUrl();
        String getEmployeeUrl = baseApiUrl + "/api/employees/" + id;
    ...
    public Employee createEmployee(Employee e) {
        String baseApiUrl = props.getApiUrl();
        String createEmployeeUrl = baseApiUrl + "/api/employees";
    ...
    public Employee updateEmployee(Employee e) {
        String baseApiUrl = props.getApiUrl();
        String updateEmployeeUrl = baseApiUrl + "/api/employees/" + e.getId();
    ...
    public void deleteEmployee(int id) {
        String baseApiUrl = props.getApiUrl();
        String deleteEmployeeUrl = baseApiUrl + "/api/employees/" + id;
